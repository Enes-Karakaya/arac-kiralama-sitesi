            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        <a href="{{ route('dashboard') }}" class="nav-item nav-link nav-link-item">Anasayfa</a>
                        <a href="{{ route('move.carsPage') }}" class="nav-item nav-link nav-link-item">Araçlarım</a>
            ...
            <div class="row g-5">
                <div class="col-md-6 col-lg-6 col-xl-3">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button class="btn btn-primary rounded-pill py-2 px-4" style="margin: 0 ; padding: 0">Çıkış Yap</button>
                    </form>
                </div>
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
