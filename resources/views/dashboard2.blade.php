            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        <a href="{{ route('move.indexPage') }}" class="nav-item nav-link nav-link-item">Anasayfa</a>
                        <a href="{{ route('move.aboutPage') }}" class="nav-item nav-link nav-link-item">Hakkında</a>
                        <a href="{{ route('move.servicePage') }}" class="nav-item nav-link nav-link-item">Hizmetlerimiz</a>

                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Sayfalar</a>
                            <div class="dropdown-menu m-0">
                                <a href="{{ route('move.featurePage') }}" class="dropdown-item nav-link-item">Özellikler
                                    </a>
                                <a href="{{ route('move.carsPage') }}" class="dropdown-item nav-link-item">Araçlar</a>
                            </div>
                        </div>
                        <a href="{{ route('move.contactPage') }}" class="nav-item nav-link nav-link-item">İletişim</a>
                    </div>

                    <a class="btn btn-primary rounded-pill py-2 px-4" style="margin: 0px 10px">Giriş Yap</a>
                    <a class="btn btn-primary rounded-pill py-2 px-4">Kaydol</a>
            ...
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-6 col-xl-3">
                    <div class="footer-item d-flex flex-column">
                        ...
                        <a href="#"><i class="fas fa-angle-right me-2"></i> Araçlar</a>
                        <a href="#"><i class="fas fa-angle-right me-2"></i> Araç Tipi</a>
